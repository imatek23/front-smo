        ...
        <div className="flex items-center justify-between pb-4">
          ...
          <div className="flex items-center justify-between w-52">
            <button className={`flex items-center justify-between p-2 ${editPanel ? 'bg-red-500' : 'bg-text-color-secundary'} rounded-lg ${editPanel ? 'text-white' : 'text-bg-color-placeholder-login'} `}>
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#ffffff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="icon icon-tabler icons-tabler-outline icon-tabler-device-floppy"><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M6 4h10l4 4v10a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2v-12a2 2 0 0 1 2 -2" /><path d="M12 14m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0" /><path d="M14 4l0 4l-6 0l0 -4" /></svg>
              Guardar
            </button>
