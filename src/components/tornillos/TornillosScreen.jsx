...
import TornillosTabla from './TornillosTabla';
import TornillosModal from './modal/TornillosModal';
import SubnavbarScreen from '../subnavbar/SubnavbarScreen';

const TornillosScreen = () => {
  const [tornillosTotales, setTornillosTotales] = useState(0);
  ...
  return (
    <div>
      <SubnavbarScreen>Augers / Tornillos</SubnavbarScreen>

      <div className='p-5'>

        <div className='flex items-center justify-between'>
          <p>Total de tornillos en el sistema: <span className='text-green-500'>{tornillosTotales}</span></p>
      ...
      {
       openModal && <TornillosModal setOpenModal={setOpenModal} />
      }
...
export default TornillosScreen  