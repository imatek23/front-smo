        ...
        <table className="table-auto border-collapse border-b border-gray-300 w-full text-sm mt-10">
            <thead>
                <tr className="bg-bg-color-placeholder-login">
                    ...
                    <th className=" border-gray-300 px-4 py-2">Nombre de Tornillo</th>
                    <th className=" border-gray-300 px-4 py-2">Código de Tornillo</th>
                    <th className=" border-gray-300 px-4 py-2">Silo</th>
