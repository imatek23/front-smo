...
const TolvasModalScreen = ({setOpenModal}) => {
    ...
    return (
        <div className='w-3/4 mx-auto bg-bg-color-auth rounded-lg p-10'>
            ...
            <div>
                <h2 className='text-2xl pb-4'>Agregar Tolvas</h2>
                <hr />
            </div>
            ...
            <form onSubmit={handleSubmit} className='w-3/4 mx-auto my-10'>
                ...
                <div className='flex items-center justify-between flex-wrap gap-y-10'>
                    <div>
                        ...
                        <input type="text" placeholder='Nombre de Tolvas' className='rounded-md bg-bg-color-placeholder-login text-white px-4 py-2' />
                    </div>
                    <div>
                        <label
                            className="block text-sm font-bold text-gray-300 mb-1"
                        ...
                        <input type="text" placeholder='Código de Tolvas' className='rounded-md bg-bg-color-placeholder-login text-white px-4 py-2' />
                    </div>
                ...
                <div className='mt-20 mx-auto flex items-center bg-bg-color-btn-login w-48 text-center py-2 px-4 rounded-lg text-gray-300 hover:text-white transition-all duration-300 cursor-pointer'>
                    ...
                    <button className='mx-auto'>Guardar Tolvas</button>
                </div>
...
export default TolvasModalScreen