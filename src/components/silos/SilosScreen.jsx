...
import SilosTabla from './SilosTabla';
import SilosModalScreen from './modal/SilosModalScreen';

const SilosScreen = () => {

  const [silosTotales, setSilosTotales] = useState(0);
  ...
  return (
    <div>
      <SubnavbarScreen>Siles / Silos</SubnavbarScreen>

      <div className='p-5'>
        <div className='flex items-center justify-between'>
          <p>Total de silos en el sistema:  <span className='text-green-500'>{silosTotales}</span></p>
      ...
      {
       openModal && <SilosModalScreen setOpenModal={setOpenModal} />
      }
    </div>
  )
}
