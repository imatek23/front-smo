...
import SensoresModalScreen from './modal/SensoresModalScreen';
import SensoresTabla from './SensoresTabla';

const SensoresScreen = () => {

  const [sensoresTotales, setSensoresTotales] = useState(0);
  ...
  return (
    <div>
      <SubnavbarScreen>Sensors / Sensores</SubnavbarScreen>


      <div className='p-5'>

        <div className='flex items-center justify-between'>
          <p>Total de sensores en el sistema: <span className='text-green-500'>{sensoresTotales}</span></p>
      ...
      {
        openModal && <SensoresModalScreen setOpenModal={setOpenModal} />
      }
